...
namespace HMS.CONSOLE.Data
{
    class MachineContext: DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) {
            ...
            {
                optionsBuilder.UseSqlServer(@"Server=localhost\SQLEXPRESS;Database=hmsDB;Trusted_Connection=True;");
            }
        ...
        protected override  void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MachineWarranty>(entity => {
                ...
                .WithMany(p => p.MachineWarranties)
            ...
            modelBuilder.Entity<OperatingSys>(entity => {
                entity.Property(e => e.OperatingSysId).HasColumnName("OperatingSysID");
                entity.Property(e => e.Name).IsRequired().HasMaxLength(35).IsUnicode(false);
            });
            ...
            modelBuilder.Entity<SupportLog>(entity => {
                ...
                entity.HasOne(d => d.SupportTicket).WithMany(p => p.SupportLog).HasForeignKey(d => d.SupportTicketId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_SupportTicket");
            ...
            modelBuilder.Entity<SupportTicket>(entity => {
                ...
                entity.Property(e => e.IssueDescription).IsRequired().IsUnicode(false);
                entity.Property(e => e.IssueDetail).IsUnicode(false);
                entity.Property(e => e.MachineId).HasColumnName("MachineID");
                entity.Property(e => e.TicketOpenedBy).IsRequired().HasMaxLength(50).IsUnicode(false);
                entity.HasOne(d => d.Machine).WithMany(p => p.SupportTickets).HasForeignKey(d => d.MachineId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_Machine");
            });
